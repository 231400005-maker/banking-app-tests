...
def test_valid_c2():
    assert calculate_interest(0,100,1) == 0
def test_valid_c3():
    assert round(calculate_interest(1,1,1),2) == 1.01
def test_invalid_c():
    with pytest.raises(ValueError):
...
def test_val2():
    assert check_loan_eligibility(5001,700) == True
def test_inval1():
